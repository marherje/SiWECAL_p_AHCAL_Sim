...
export MARLIN_DLL=$PWD/lib/libShapingProcessor.so:$MARLIN_DLL
#export MARLIN_DLL=$PWD/lib/libConversionProcessor.so:$MARLIN_DLL
#export MARLIN_DLL=$PWD/lib/libDigiLCIO2BuildProcessor.so:$MARLIN_DLL

Marlin steering/templates/tests_JP_TB2022-06_CONF6/Shaping_test.xml

mv *root test_outputs/.
mv *slcio test_outputs/.
