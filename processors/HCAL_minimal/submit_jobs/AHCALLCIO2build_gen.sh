...
Marlin $ORIGIN/submit_jobs/AHCALLCIO2build_folder/AHCALLCIO2build_steer/XcondorfileX.xml

mv *root $ORIGIN/submit_jobs/AHCALLCIO2build_folder/AHCALLCIO2build_output/.
mv outfile* $ORIGIN/submit_jobs/AHCALLCIO2build_folder/AHCALLCIO2build_log/.
mv *log $ORIGIN/submit_jobs/AHCALLCIO2build_folder/AHCALLCIO2build_log/.
mv error* $ORIGIN/submit_jobs/AHCALLCIO2build_folder/AHCALLCIO2build_log/.
