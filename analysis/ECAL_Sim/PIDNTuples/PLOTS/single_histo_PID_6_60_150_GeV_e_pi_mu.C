...
void drawHistosTH1(TString varname, TH1 * he, TH1 * hmu, TH1 * hpi, bool save = false) {
  ...
  auto c = new TCanvas("c_PID_6_60_150_GeV_e_pi_mu_"+varname, "c_PID_6_60_150_GeV_e_pi_mu_"+varname, 800, 800);
  c->cd();
  ...
  leg->SetTextFont(42);
  leg->AddEntry(he,"e- (6,60,150 GeV)","l");
  leg->AddEntry(hpi,"pi- (6,60,150 GeV)","l");
  leg->AddEntry(hmu,"mu- (6,60,150 GeV)","l");
  leg->SetFillColor(0);
  leg->SetLineColor(0);
  ...
  if(save == true){
    c->SaveAs("c_PID_6_60_150_GeV_e_pi_mu_"+varname+".eps");
    c->SaveAs("c_PID_6_60_150_GeV_e_pi_mu_"+varname+".png");
  }
}

void single_histo_PID_6_60_150_GeV_e_pi_mu(TString varname, bool save = false){

  TString filename_e = "../PID_6_60_150_GeV_e_pi_mu/resolution_e-_result.root";
  TString filename_pi = "../PID_6_60_150_GeV_e_pi_mu/resolution_pi-_result.root";
  TString filename_mu = "../PID_6_60_150_GeV_e_pi_mu/resolution_mu-_result.root";
  ...
  file_pi->GetObject(varname+"_pi-", histo_pi);
  file_mu->GetObject(varname+"_mu-", histo_mu);
