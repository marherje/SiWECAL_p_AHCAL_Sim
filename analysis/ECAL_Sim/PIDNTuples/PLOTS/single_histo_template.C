...
void drawHistosTH1(TString varname, TH1 * he, TH1 * hmu, TH1 * hpi, bool save = false) {
  ...
  leg->SetTextFont(42);
  leg->AddEntry(he,"XsetAX","l");
  leg->AddEntry(hpi,"XsetBX","l");
  leg->AddEntry(hmu,"XsetCX","l");
  leg->SetFillColor(0);
  leg->SetLineColor(0);
...
void single_histo_XproductionX(TString varname, bool save = false){
  ...
  TString filename_e = "../XproductionX/resolution_XresAX_result.root";
  TString filename_pi = "../XproductionX/resolution_XresBX_result.root";
  TString filename_mu = "../XproductionX/resolution_XresCX_result.root";
  ...
  file_e->GetObject(varname+"_XpartAX", histo_e);
  file_pi->GetObject(varname+"_XpartBX", histo_pi);
  file_mu->GetObject(varname+"_XpartCX", histo_mu);
