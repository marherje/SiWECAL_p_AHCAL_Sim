...
void cheap_trick_sigma(double shower_fit_result[N_ECAL_LAYERS][2]) {

  double shower_fit_result_new[N_ECAL_LAYERS][2];
  /*
  cout<<"sigmas before: ";
  for(int ilayer = 0; ilayer<N_ECAL_LAYERS; ilayer++) {
    cout<<abs(shower_fit_result[ilayer][1])<<" ";
  }
  cout<<""<<endl;
  */
  for(int ilayer = 0; ilayer<N_ECAL_LAYERS; ilayer++) {
  ...
  for(int ilayer = 0; ilayer<N_ECAL_LAYERS; ilayer++) {
    if(ilayer < 12) {
      ...
      double temp1 = abs(shower_fit_result[ilayer+1][1]);
      double temp2 = abs(shower_fit_result[ilayer+2][1]);
      if( (temp !=0) && (temp < 40)) shower_fit_result_new[ilayer][1] = temp;
      else if( (temp1 !=0) && (temp1 < 40)) shower_fit_result_new[ilayer][1] = temp1;
      else if( (temp1 !=0) && (temp1 < 40)) shower_fit_result_new[ilayer][1] = temp2;
    }
    else {
      double temp = abs(shower_fit_result[ilayer][1]);
      double temp1 = abs(shower_fit_result[ilayer-1][1]);
...
void analysis (string particle) {
	...
	cheap_trick_sigma(nhit_shower_fit_result);
	...
	cheap_trick_sigma(nhit_shower_fit_result_n);
	...
	cheap_trick_sigma(weight_shower_fit_result);
	...
	cheap_trick_sigma(weight_shower_fit_result_n);
	...
	cheap_trick_sigma(bar_x_fit_result);
	...
	cheap_trick_sigma(bar_y_fit_result);
