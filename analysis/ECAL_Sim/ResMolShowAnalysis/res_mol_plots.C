...
void res_mol_plots(string particle, bool transformed = true, bool save = false){
    ...
    TVectorD *barycenter_x, *barycenter_y, *barycenter_z;
    TVectorD *barycenter_x_masked, *barycenter_y_masked, *barycenter_z_masked;
    ...
    TVectorD *mu_nhit_layer_n_0, *sig_nhit_layer_n_0;
    TVectorD *mu_nhit_layer_n_1, *sig_nhit_layer_n_1;
    TVectorD *mu_nhit_layer_n_2, *sig_nhit_layer_n_2;
    TVectorD *mu_nhit_layer_n_3, *sig_nhit_layer_n_3;
    TVectorD *mu_nhit_layer_n_4, *sig_nhit_layer_n_4;
    TVectorD *mu_nhit_layer_n_5, *sig_nhit_layer_n_5;
    TVectorD *mu_nhit_layer_n_6, *sig_nhit_layer_n_6;
    TVectorD *mu_nhit_layer_n_7, *sig_nhit_layer_n_7;
    TVectorD *mu_nhit_layer_n_8, *sig_nhit_layer_n_8;
    TVectorD *mu_nhit_layer_n_9, *sig_nhit_layer_n_9;
    TVectorD *mu_nhit_layer_n_10, *sig_nhit_layer_n_10;
    TVectorD *mu_nhit_layer_n_11, *sig_nhit_layer_n_11;
    TVectorD *mu_nhit_layer_n_12, *sig_nhit_layer_n_12;
    TVectorD *mu_nhit_layer_n_13, *sig_nhit_layer_n_13;
    TVectorD *mu_nhit_layer_n_14, *sig_nhit_layer_n_14;
    TVectorD *shower_nhit_max_layer, *shower_nhit_start_layer, *shower_nhit_end_layer, *shower_nhit_max, *shower_nhit_average;

    TVectorD *mu_weight_layer_0, *sig_weight_layer_0;
    TVectorD *mu_weight_layer_1, *sig_weight_layer_1;
    TVectorD *mu_weight_layer_2, *sig_weight_layer_2;
    TVectorD *mu_weight_layer_3, *sig_weight_layer_3;
    TVectorD *mu_weight_layer_4, *sig_weight_layer_4;
    TVectorD *mu_weight_layer_5, *sig_weight_layer_5;
    TVectorD *mu_weight_layer_6, *sig_weight_layer_6;
    TVectorD *mu_weight_layer_7, *sig_weight_layer_7;
    TVectorD *mu_weight_layer_8, *sig_weight_layer_8;
    TVectorD *mu_weight_layer_9, *sig_weight_layer_9;
    TVectorD *mu_weight_layer_10, *sig_weight_layer_10;
    TVectorD *mu_weight_layer_11, *sig_weight_layer_11;
    TVectorD *mu_weight_layer_12, *sig_weight_layer_12;
    TVectorD *mu_weight_layer_13, *sig_weight_layer_13;
    TVectorD *mu_weight_layer_14, *sig_weight_layer_14;
    TVectorD *mu_weight_layer_n_0, *sig_weight_layer_n_0;
    TVectorD *mu_weight_layer_n_1, *sig_weight_layer_n_1;
    TVectorD *mu_weight_layer_n_2, *sig_weight_layer_n_2;
    TVectorD *mu_weight_layer_n_3, *sig_weight_layer_n_3;
    TVectorD *mu_weight_layer_n_4, *sig_weight_layer_n_4;
    TVectorD *mu_weight_layer_n_5, *sig_weight_layer_n_5;
    TVectorD *mu_weight_layer_n_6, *sig_weight_layer_n_6;
    TVectorD *mu_weight_layer_n_7, *sig_weight_layer_n_7;
    TVectorD *mu_weight_layer_n_8, *sig_weight_layer_n_8;
    TVectorD *mu_weight_layer_n_9, *sig_weight_layer_n_9;
    TVectorD *mu_weight_layer_n_10, *sig_weight_layer_n_10;
    TVectorD *mu_weight_layer_n_11, *sig_weight_layer_n_11;
    TVectorD *mu_weight_layer_n_12, *sig_weight_layer_n_12;
    TVectorD *mu_weight_layer_n_13, *sig_weight_layer_n_13;
    TVectorD *mu_weight_layer_n_14, *sig_weight_layer_n_14;
    TVectorD *shower_weight_max_layer, *shower_weight_start_layer, *shower_weight_end_layer, *shower_weight_max, *shower_weight_average;
    ...
    file->GetObject("barycenter_x", barycenter_x);
    file->GetObject("barycenter_y", barycenter_y);
    file->GetObject("barycenter_z", barycenter_z);
    file->GetObject("barycenter_x_masked", barycenter_x_masked);
    file->GetObject("barycenter_y_masked", barycenter_y_masked);
    file->GetObject("barycenter_z_masked", barycenter_z_masked);
    ...
    file->GetObject("mu_nhit_layer_n_0", mu_nhit_layer_n_0);
    file->GetObject("mu_nhit_layer_n_1", mu_nhit_layer_n_1);
    file->GetObject("mu_nhit_layer_n_2", mu_nhit_layer_n_2);
    file->GetObject("mu_nhit_layer_n_3", mu_nhit_layer_n_3);
    file->GetObject("mu_nhit_layer_n_4", mu_nhit_layer_n_4);
    file->GetObject("mu_nhit_layer_n_5", mu_nhit_layer_n_5);
    file->GetObject("mu_nhit_layer_n_6", mu_nhit_layer_n_6);
    file->GetObject("mu_nhit_layer_n_7", mu_nhit_layer_n_7);
    file->GetObject("mu_nhit_layer_n_8", mu_nhit_layer_n_8);
    file->GetObject("mu_nhit_layer_n_9", mu_nhit_layer_n_9);
    file->GetObject("mu_nhit_layer_n_10", mu_nhit_layer_n_10);
    file->GetObject("mu_nhit_layer_n_11", mu_nhit_layer_n_11);
    file->GetObject("mu_nhit_layer_n_12", mu_nhit_layer_n_12);
    file->GetObject("mu_nhit_layer_n_13", mu_nhit_layer_n_13);
    file->GetObject("mu_nhit_layer_n_14", mu_nhit_layer_n_14);
    file->GetObject("sig_nhit_layer_n_0", sig_nhit_layer_n_0);
    file->GetObject("sig_nhit_layer_n_1", sig_nhit_layer_n_1);
    file->GetObject("sig_nhit_layer_n_2", sig_nhit_layer_n_2);
    file->GetObject("sig_nhit_layer_n_3", sig_nhit_layer_n_3);
    file->GetObject("sig_nhit_layer_n_4", sig_nhit_layer_n_4);
    file->GetObject("sig_nhit_layer_n_5", sig_nhit_layer_n_5);
    file->GetObject("sig_nhit_layer_n_6", sig_nhit_layer_n_6);
    file->GetObject("sig_nhit_layer_n_7", sig_nhit_layer_n_7);
    file->GetObject("sig_nhit_layer_n_8", sig_nhit_layer_n_8);
    file->GetObject("sig_nhit_layer_n_9", sig_nhit_layer_n_9);
    file->GetObject("sig_nhit_layer_n_10", sig_nhit_layer_n_10);
    file->GetObject("sig_nhit_layer_n_11", sig_nhit_layer_n_11);
    file->GetObject("sig_nhit_layer_n_12", sig_nhit_layer_n_12);
    file->GetObject("sig_nhit_layer_n_13", sig_nhit_layer_n_13);
    file->GetObject("sig_nhit_layer_n_14", sig_nhit_layer_n_14);
    ...
    //weighted energy
    file->GetObject("mu_weight_layer_0", mu_weight_layer_0);
    file->GetObject("mu_weight_layer_1", mu_weight_layer_1);
    file->GetObject("mu_weight_layer_2", mu_weight_layer_2);
    file->GetObject("mu_weight_layer_3", mu_weight_layer_3);
    file->GetObject("mu_weight_layer_4", mu_weight_layer_4);
    file->GetObject("mu_weight_layer_5", mu_weight_layer_5);
    file->GetObject("mu_weight_layer_6", mu_weight_layer_6);
    file->GetObject("mu_weight_layer_7", mu_weight_layer_7);
    file->GetObject("mu_weight_layer_8", mu_weight_layer_8);
    file->GetObject("mu_weight_layer_9", mu_weight_layer_9);
    file->GetObject("mu_weight_layer_10", mu_weight_layer_10);
    file->GetObject("mu_weight_layer_11", mu_weight_layer_11);
    file->GetObject("mu_weight_layer_12", mu_weight_layer_12);
    file->GetObject("mu_weight_layer_13", mu_weight_layer_13);
    file->GetObject("mu_weight_layer_14", mu_weight_layer_14);
    file->GetObject("sig_weight_layer_0", sig_weight_layer_0);
    file->GetObject("sig_weight_layer_1", sig_weight_layer_1);
    file->GetObject("sig_weight_layer_2", sig_weight_layer_2);
    file->GetObject("sig_weight_layer_3", sig_weight_layer_3);
    file->GetObject("sig_weight_layer_4", sig_weight_layer_4);
    file->GetObject("sig_weight_layer_5", sig_weight_layer_5);
    file->GetObject("sig_weight_layer_6", sig_weight_layer_6);
    file->GetObject("sig_weight_layer_7", sig_weight_layer_7);
    file->GetObject("sig_weight_layer_8", sig_weight_layer_8);
    file->GetObject("sig_weight_layer_9", sig_weight_layer_9);
    file->GetObject("sig_weight_layer_10", sig_weight_layer_10);
    file->GetObject("sig_weight_layer_11", sig_weight_layer_11);
    file->GetObject("sig_weight_layer_12", sig_weight_layer_12);
    file->GetObject("sig_weight_layer_13", sig_weight_layer_13);
    file->GetObject("sig_weight_layer_14", sig_weight_layer_14);

    file->GetObject("mu_weight_layer_n_0", mu_weight_layer_n_0);
    file->GetObject("mu_weight_layer_n_1", mu_weight_layer_n_1);
    file->GetObject("mu_weight_layer_n_2", mu_weight_layer_n_2);
    file->GetObject("mu_weight_layer_n_3", mu_weight_layer_n_3);
    file->GetObject("mu_weight_layer_n_4", mu_weight_layer_n_4);
    file->GetObject("mu_weight_layer_n_5", mu_weight_layer_n_5);
    file->GetObject("mu_weight_layer_n_6", mu_weight_layer_n_6);
    file->GetObject("mu_weight_layer_n_7", mu_weight_layer_n_7);
    file->GetObject("mu_weight_layer_n_8", mu_weight_layer_n_8);
    file->GetObject("mu_weight_layer_n_9", mu_weight_layer_n_9);
    file->GetObject("mu_weight_layer_n_10", mu_weight_layer_n_10);
    file->GetObject("mu_weight_layer_n_11", mu_weight_layer_n_11);
    file->GetObject("mu_weight_layer_n_12", mu_weight_layer_n_12);
    file->GetObject("mu_weight_layer_n_13", mu_weight_layer_n_13);
    file->GetObject("mu_weight_layer_n_14", mu_weight_layer_n_14);
    file->GetObject("sig_weight_layer_n_0", sig_weight_layer_n_0);
    file->GetObject("sig_weight_layer_n_1", sig_weight_layer_n_1);
    file->GetObject("sig_weight_layer_n_2", sig_weight_layer_n_2);
    file->GetObject("sig_weight_layer_n_3", sig_weight_layer_n_3);
    file->GetObject("sig_weight_layer_n_4", sig_weight_layer_n_4);
    file->GetObject("sig_weight_layer_n_5", sig_weight_layer_n_5);
    file->GetObject("sig_weight_layer_n_6", sig_weight_layer_n_6);
    file->GetObject("sig_weight_layer_n_7", sig_weight_layer_n_7);
    file->GetObject("sig_weight_layer_n_8", sig_weight_layer_n_8);
    file->GetObject("sig_weight_layer_n_9", sig_weight_layer_n_9);
    file->GetObject("sig_weight_layer_n_10", sig_weight_layer_n_10);
    file->GetObject("sig_weight_layer_n_11", sig_weight_layer_n_11);
    file->GetObject("sig_weight_layer_n_12", sig_weight_layer_n_12);
    file->GetObject("sig_weight_layer_n_13", sig_weight_layer_n_13);
    file->GetObject("sig_weight_layer_n_14", sig_weight_layer_n_14);

    file->GetObject("shower_weight_max_layer", shower_weight_max_layer);
    file->GetObject("shower_weight_start_layer", shower_weight_start_layer);
    file->GetObject("shower_weight_end_layer", shower_weight_end_layer);
    file->GetObject("shower_weight_max", shower_weight_max);
    file->GetObject("shower_weight_average", shower_weight_average);
