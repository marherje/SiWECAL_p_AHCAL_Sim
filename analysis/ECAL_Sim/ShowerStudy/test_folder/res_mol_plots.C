...
void res_mol_plots(string particle, bool transformed = true, bool save = false){
    ...
    TVectorD *barycenter_x = new TVectorD(N_ENERGIES);
    TVectorD *barycenter_y = new TVectorD(N_ENERGIES);
    TVectorD *barycenter_z = new TVectorD(N_ENERGIES);
    
    TVectorD *mu_nhit_layer_0 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_0 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_1 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_1 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_2 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_2 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_3 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_3 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_4 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_4 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_5 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_5 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_6 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_6 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_7 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_7 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_8 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_8 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_9 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_9 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_10 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_10 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_11 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_11 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_12 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_12 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_13 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_13 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_14 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_14 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_0 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_0 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_1 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_1 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_2 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_2 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_3 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_3 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_4 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_4 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_5 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_5 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_6 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_6 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_7 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_7 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_8 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_8 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_9 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_9 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_10 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_10 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_11 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_11 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_12 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_12 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_13 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_13 = new TVectorD(N_ENERGIES);
    TVectorD *mu_nhit_layer_n_14 = new TVectorD(N_ENERGIES); TVectorD *sig_nhit_layer_n_14 = new TVectorD(N_ENERGIES);
    TVectorD *shower_nhit_max_layer = new TVectorD(N_ENERGIES); TVectorD *shower_nhit_start_layer = new TVectorD(N_ENERGIES); TVectorD *shower_nhit_end_layer = new TVectorD(N_ENERGIES); TVectorD *shower_nhit_max = new TVectorD(N_ENERGIES); TVectorD *shower_nhit_average = new TVectorD(N_ENERGIES);

    TVectorD *mu_weight_layer_0 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_0 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_1 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_1 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_2 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_2 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_3 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_3 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_4 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_4 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_5 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_5 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_6 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_6 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_7 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_7 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_8 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_8 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_9 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_9 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_10 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_10 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_11 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_11 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_12 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_12 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_13 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_13 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_14 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_14 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_0 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_0 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_1 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_1 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_2 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_2 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_3 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_3 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_4 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_4 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_5 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_5 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_6 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_6 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_7 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_7 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_8 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_8 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_9 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_9 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_10 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_10 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_11 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_11 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_12 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_12 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_13 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_13 = new TVectorD(N_ENERGIES);
    TVectorD *mu_weight_layer_n_14 = new TVectorD(N_ENERGIES); TVectorD *sig_weight_layer_n_14 = new TVectorD(N_ENERGIES);
    TVectorD *shower_weight_max_layer = new TVectorD(N_ENERGIES); TVectorD *shower_weight_start_layer = new TVectorD(N_ENERGIES); TVectorD *shower_weight_end_layer = new TVectorD(N_ENERGIES); TVectorD *shower_weight_max  = new TVectorD(N_ENERGIES); TVectorD *shower_weight_average = new TVectorD(N_ENERGIES);
    ...
    TVectorD *barycenter_x_cycle = (TVectorD*)(file->FindObjectAny(("barycenter_x"+icycle).c_str()));
    TVectorD *barycenter_y_cycle = (TVectorD*)(file->FindObjectAny(("barycenter_y"+icycle).c_str()));
    TVectorD *barucenter_z_cycle = (TVectorD*)(file->FindObjectAny(("barycenter_z"+icycle).c_str()));
    ...
    TVectorD * shpwer_nhit_max_layer_cycle = (TVectorD*)(file->FindObjectAny(("shower_nhit_max_layer"+icycle).c_str()));
    TVectorD * shpwer_nhit_start_layer_cycle = (TVectorD*)(file->FindObjectAny(("shower_nhit_start_layer"+icycle).c_str()));
    TVectorD * shpwer_nhit_end_layer_cycle = (TVectorD*)(file->FindObjectAny(("shower_nhit_end_layer"+icycle).c_str()));
    TVectorD * shpwer_nhit_max_cycle = (TVectorD*)(file->FindObjectAny(("shower_nhit_max"+icycle).c_str()));
    TVectorD * shpwer_nhit_average_cycle = (TVectorD*)(file->FindObjectAny(("shower_nhit_average"+icycle).c_str()));
