...
void res_mol_plots(string particle, bool transformed = true, bool save = false){
    ...
    mg_shower_X0_nhit_energies->GetXaxis()->SetRangeUser(1,21);
    ...
    c_shower_X0_weight_energies->cd();
    ...
    mg_shower_X0_weight_energies->GetXaxis()->SetRangeUser(1,21);
    ...
    c_shower_weight_start_layer->cd();
    ...
    mg_shower_X0_sume_energies->GetXaxis()->SetRangeUser(1,21);
