...
void analysis_singlefile (string particle, bool masked=false) {
    
    // double energies[N_ENERGIES] = {1, 2, 5, 8, 10, 20, 40, 60, 80, 100, 150};
    double test_e[N_ENERGIES]={XENERGIESX};
    ...
    // Output filename
    TString result_name = "resolution_"+particle+"_singlefile_result.root" ;
