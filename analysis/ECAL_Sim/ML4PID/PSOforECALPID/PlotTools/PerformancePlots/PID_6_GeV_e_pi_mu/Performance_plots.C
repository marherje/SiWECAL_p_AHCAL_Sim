...
void addProduction(){
  ...
  p1->Draw();
  p1->cd();
  TString title = "PID_6_GeV_e_pi_mu";
...
void drawLikelihood(TString title, TH1F * hA, TH1F * hB, TH1F * hC, bool save = false) {
  ...
  auto c = new TCanvas("c_PID_6_GeV_e_pi_mu_"+title, "c_PID_6_GeV_e_pi_mu_"+title, 800, 800);
  c->cd();
  ...
  if(save == true){
    c->SaveAs("c_PID_6_GeV_e_pi_mu_"+title+".eps");
    c->SaveAs("c_PID_6_GeV_e_pi_mu_"+title+".png");
  }
  ...
  auto c2 = new TCanvas("c_PID_6_GeV_e_pi_mu_"+title+"_cut", "c_PID_6_GeV_e_pi_mu_"+title+"_cut", 800, 800);
  c2->cd();
  ...
  if(save == true){
    c2->SaveAs("c_PID_6_GeV_e_pi_mu_"+title+"_cut.eps");
    c2->SaveAs("c_PID_6_GeV_e_pi_mu_"+title+"_cut.png");
  }
...
void drawCorrelation(TString particle, vector<TString> varnames, TH2F * hA, bool save=false) {
  ...
  auto c_A = new TCanvas("c_PID_6_GeV_e_pi_mu_X_Correlation_"+particle,"c_PID_6_GeV_e_pi_mu_X_Correlation_"+particle,800,800);
  c_A->cd();
  ...
  if(save == true){
    c_A->SaveAs("c_PID_6_GeV_e_pi_mu_correlation_"+particle+".eps");
    c_A->SaveAs("c_PID_6_GeV_e_pi_mu_correlation_"+particle+".png");
  }
}
...
void Performance_plots(bool save = false){
  ...
  TFile* outputfile=TFile::Open("../ROOTFiles/PID_6_GeV_e_pi_mu_TMVA.root");
