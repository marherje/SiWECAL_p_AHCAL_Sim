...
python runPSO.py -c config/PID_150_GeV_e_pi_mu/PID_150_GeV_e_pi_mu_allvars.txt -o output/PID_150_GeV_e_pi_mu_allvars > log/Log_PID_150_GeV_e_pi_mu_allvars.log
