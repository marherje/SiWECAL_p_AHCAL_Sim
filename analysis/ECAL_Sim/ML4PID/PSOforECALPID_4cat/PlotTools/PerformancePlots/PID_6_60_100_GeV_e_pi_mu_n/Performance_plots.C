...
void drawLikelihood(TString title, TH1F * hA, TH1F * hB, TH1F * hC, TH1F * hD, bool save = false) {
  ...
  auto c = new TCanvas("c_PID_6_60_100_GeV_e_pi_mu_n_"+title, "c_PID_6_60_100_GeV_e_pi_mu_n_"+title, 800, 800);
  c->cd();
  ...
  addProduction();
  if(save == true){
    c->SaveAs("c_PID_6_60_100_GeV_e_pi_mu_n_"+title+".eps");
    c->SaveAs("c_PID_6_60_100_GeV_e_pi_mu_n_"+title+".png");
  }
  ...
  auto c2 = new TCanvas("c_PID_6_60_100_GeV_e_pi_mu_n_"+title+"_cut", "c_PID_6_60_100_GeV_e_pi_mu_n_"+title+"_cut", 800, 800);
  c2->cd();
  ...
  addProduction();
  if(save == true){
    c2->SaveAs("c_PID_6_60_100_GeV_e_pi_mu_n_"+title+"_cut.eps");
    c2->SaveAs("c_PID_6_60_100_GeV_e_pi_mu_n_"+title+"_cut.png");
  }
...
void drawCorrelation(TString particle, vector<TString> varnames, TH2F * hA, bool save=false) {
  ...
  addProduction();
  if(save == true){
    c_A->SaveAs("c_PID_6_60_100_GeV_e_pi_mu_n_correlation_"+particle+".eps");
    c_A->SaveAs("c_PID_6_60_100_GeV_e_pi_mu_n_correlation_"+particle+".png");
  }
}
...
void Performance_plots(bool save = false){
  ...
  TFile* outputfile=TFile::Open("../ROOTFiles/PID_6_60_100_GeV_e_pi_mu_n_TMVA.root");
