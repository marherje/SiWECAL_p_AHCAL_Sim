    ...
    def __init__(self, OutputDir='', DataSubdir='InitData', Verbose=True, PSOConfig=''):
      ...
      for line in configLines:
        ...
        if "nTrain_N" in line:
          buff=line.split("=",1)[1]
          if buff!="" and buff!=" ":
            self.PreparationString="nTrain_N="+buff+":"+self.PreparationString
        if "nTest_C" in line:
          buff=line.split("=",1)[1]
          if buff!="" and buff!=" ":
        ...
        if "nTest_N" in line:
          buff=line.split("=",1)[1]
          if buff!="" and buff!=" ":
            self.PreparationString="nTest_N="+buff+":"+self.PreparationString
        ...
        if "NWeightExpression" in line:
          self.NWeightExpression=line.split("=",1)[1]
        ...
        if "SourceNTree" in line:
          self.NTreeName=line.split("=",1)[1]
...
#        for part in self.Particles: part.SaveParticleStatus()
        ...
        bestBDTFile.write('NWeight '+str(self.NWeightExpression)    +'\n')
