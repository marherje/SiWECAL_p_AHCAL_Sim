...
class Particle:
    ...
    def WriteConfig(self):
      ...
      configfile.write("NWeightExpression "+str(self.NWeightExpression)+"\n")
      ...
      configfile.write("NTreeName "+str(self.NTreeName)+"\n")
