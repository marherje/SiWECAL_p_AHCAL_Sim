...
python runPSO.py -c config/Both_PID_6_GeV_kaon_pi_mu_neutron/Both_PID_6_GeV_kaon_pi_mu_neutron_it0.txt -o output/Both_PID_6_GeV_kaon_pi_mu_neutron_it0 > log/Log_Both_PID_6_GeV_kaon_pi_mu_neutron_it0.log
