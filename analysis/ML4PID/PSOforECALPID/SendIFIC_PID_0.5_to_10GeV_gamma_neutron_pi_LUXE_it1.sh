...
python runPSO.py -c config/PID_0.5_to_10_GeV_gamma_neutron_pi_LUXE/PID_0.5_to_10_GeV_gamma_neutron_pi_LUXE_it1.txt -o output/PID_0.5_to_10_GeV_gamma_neutron_pi_LUXE_it1 > log/Log_PID_0.5_to_10_GeV_gamma_neutron_pi_LUXE_it1.log
