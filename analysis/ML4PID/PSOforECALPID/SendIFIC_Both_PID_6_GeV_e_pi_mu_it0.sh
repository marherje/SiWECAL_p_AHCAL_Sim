...
python runPSO.py -c config/Both_PID_6_GeV_e_pi_mu/Both_PID_6_GeV_e_pi_mu_it0.txt -o output/Both_PID_6_GeV_e_pi_mu_it0 > log/Log_Both_PID_6_GeV_e_pi_mu_it0.log
